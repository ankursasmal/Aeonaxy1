...
<h1 className='font-bold pb-[2.2vh] text-[3vh] lg:text-[4vh]  '>Getting started</h1>
...
<a> You can make channels <b> public </b>to make all docs visible to everyone on the team, or <b> private</b>  if you want the channel's docs to only be visible by a selection of</a>
 ...
 <a className='mt-[2vh] mb-[1.1vh]  text-[3vh] lg:text-[4vh]font-semibold line-height-1'>Collaborate with your team with these three features</a>
     <div className='flex items-center'>
        ...
        <a className='text-[4vh] font-bold pl-[2vw]'>Doc</a>
     </div>
